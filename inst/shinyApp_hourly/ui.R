ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(1,
      fluidRow(
        dateInput("date1", label = h3(tr("Beg")), value = "2099-09-09",format = "dd.mm.yyyy")
      ),
      sliderInput("hour1", label = NULL, min = 0,
        max = 23, value = 12)
    ),
    column(1,
      fluidRow(
        dateInput("date2", label = h3(tr("End")), value = "2099-09-09" ,format ="dd.mm.yyyy")
      ),
      sliderInput("hour2", label = NULL, min = 0,
        max = 23, value = 12)
    ),
    column(2,
